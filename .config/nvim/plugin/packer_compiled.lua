...
_G.packer_plugins = {
  ...
  ["live-server.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/frank/.local/share/nvim/site/pack/packer/opt/live-server.nvim",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/home/frank/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  nvim = {
    loaded = true,
    path = "/home/frank/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/home/frank/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
